...
const cat1: Category = { id: 'cat-1', name: 'Work', color: '#3b82f6', createdAt: '' }
const cat2: Category = { id: 'cat-2', name: 'Health', color: '#22c55e', createdAt: '' }
...
describe('getCategoryCompletionStats', () => {
  ...
  it('includes uncategorized bucket for tasks without categoryId', () => {
    const tasks = [
      ...
      makeTask({ categoryId: undefined, completedAt: new Date().toISOString() }),
    ]

...
const TaskFormView = lazy(() => import('@/views/TaskFormView').then(m => ({ default: m.TaskFormView })))
...
const CategoryAnalyticsView = lazy(() => import('@/views/CategoryAnalyticsView').then(m => ({ default: m.CategoryAnalyticsView })))
